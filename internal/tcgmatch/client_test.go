...
func TestMetadataAndAutocompleteUseCatalogFields(t *testing.T) {
	...
	if err != nil || metadata.Name != "Dark Magician" || metadata.Image != "https://images.example/dark-magician.jpg" {
...
func TestSearch(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			catalog: `{"products":[{"id":31969,"name":"Charizard ex - 125/197","tcg":"pokemon","type":"card"}]}`,
